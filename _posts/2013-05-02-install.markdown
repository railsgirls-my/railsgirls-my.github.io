...
Alternatively, you can use [Nitrous.IO](https://nitrous.io) and build the app using only your browser. Check the [quick setup guide]({% post_url 2014-08-11-nitrous %}) for Nitrous.IO.
